...
if not st.session_state.logado:
    ...
    st.markdown('<div class="l-icon"><img src="https://raw.githubusercontent.com/Nicolasfami/sistema-vendas/main/logo_sem_escrita.png" style="width:280px;height:280px;object-fit:contain;"></div>', unsafe_allow_html=True)
