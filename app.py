...
if not st.session_state.logado:
    ...
    st.markdown('<div class="l-icon"><img src="https://raw.githubusercontent.com/Nicolasfami/sistema-vendas/main/logo_sem_escrita.png" style="width:100%;max-width:400px;object-fit:contain;margin:0 auto;display:block;"></div>', unsafe_allow_html=True)
